...
<!-- Top Bar End -->
<title>Bảng điều khiển | Molle Co., Ltd</title>
							...
							<div class="card-body">
								<div class="icon-contain">
									<div class="row">
										...
										<div class="col-10 text-right">
											<h5 class="mt-0 mb-1">1.161,81 $</h5>
										...
										<td class="border-top-0">
											<div class="media">
												<img src="img/accounts/noavt.png"
													class="thumb-md rounded-circle">
												<div class="media-body ml-2">
													<p class="mb-0">Xuân Mã</p>
													<span class="font-12 text-muted">bmaclee2</span>
												</div>
											</div>
										</td>
									</tr>
										...
										<td class="border-top-0">
											<div class="media">
												<img src="img/accounts/noavt.png"
													class="thumb-md rounded-circle">
												<div class="media-body ml-2">
													<p class="mb-0">Phong Giao</p>
													<span class="font-12 text-muted">cbatille</span>
												</div>
											</div>
										</td>
									</tr>
										...
										<td class="border-top-0">
											<div class="media">
												<img src="img/accounts/noavt.png"
													class="thumb-md rounded-circle">
												<div class="media-body ml-2">
													<p class="mb-0">Huỳnh Kim</p>
													<span class="font-12 text-muted">crafeoa</span>
												</div>
											</div>
										</td>
									</tr>
										...
										<td class="border-top-0">
											<div class="media">
												<img src="img/accounts/noavt.png"
													class="thumb-md rounded-circle">
												<div class="media-body ml-2">
													<p class="mb-0">Thoa Bùi</p>
													<span class="font-12 text-muted">dstewart</span>
												</div>
											</div>
										</td>
									</tr>
										...
										<td class="border-top-0">
											<div class="media">
												<img src="img/accounts/noavt.png"
													class="thumb-md rounded-circle">
												<div class="media-body ml-2">
													<p class="mb-0">Nguyễn Hoàng Duy</p>
													<span class="font-12 text-muted">duyplus</span>
												</div>
											</div>
										</td>
									</tr>
