...
<title>Ludus - Thông Tin Cá Bạn</title>
						...
						<div class="breadcrumb">
							<div class="breadcrumb__wrap">
								<ul class="breadcrumb__list">
									...
									<li class="is-marked"><a href="dash-my-profile">Tài Khoản Của Tôi</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div
										...
										<div class="dash__pad-1">
											...
											<ul class="dash__f-list">
												...
												<li><a class="dash-active" href="dash-my-profile">Thông
														tin của tôi</a></li>
								...
								<div class="col-lg-9 col-md-12">
									<div
										...
										<div class="dash__pad-2">
											<h1 class="dash__h1 u-s-m-b-14">Thông tin của tôi</h1>

											<span class="dash__text u-s-m-b-30">Xem tất cả thông
												tin của bạn, bạn có thể tùy chỉnh hồ sơ của mình.</span>
											<div class="row">
												<div class="col-lg-4 u-s-m-b-30">
													<h2 class="dash__h2 u-s-m-b-8">Họ Và Tên</h2>

													<span class="dash__text">Võ Thái Hòa</span>
												</div>
												<div class="col-lg-4 u-s-m-b-30">
													<h2 class="dash__h2 u-s-m-b-8">E-mail</h2>
													<span class="dash__text">hoavo@gmail.com</span>
												</div>
												<div class="col-lg-4 u-s-m-b-30">
													<h2 class="dash__h2 u-s-m-b-8">Số Điện Thoại</h2>
													<span class="dash__text">0392677003</span>
												</div>
												<div class="col-lg-4 u-s-m-b-30">
													<h2 class="dash__h2 u-s-m-b-8">Ngày Sinh</h2>

													<span class="dash__text">19-10-2003</span>
												</div>
												<div class="col-lg-4 u-s-m-b-30">
													<h2 class="dash__h2 u-s-m-b-8">Giới Tính</h2>
												...
												<div class="col-lg-12">
													...
													<div class="u-s-m-b-16">
														...
														<a class="dash__custom-link btn--e-transparent-brand-b-2"
															href="dash-edit-profile">Chỉnh sửa hồ sơ</a>
													</div>
													<div>

														<a class="dash__custom-link btn--e-brand-b-2" href="lost-password">Đặt Lại Mật Khẩu</a>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="modal-body">
						<form class="d-modal__form">
							<div class="u-s-m-b-15">
								<h1 class="gl-modal-h1">Đăng ký bản tin</h1>

								<span class="gl-modal-text">Tôi đã đọc và hiểu</span> <a
									class="d_modal__link" href="dash-my-profile">Chính sách bảo mật QuickBuy</a>
							</div>
							<div class="gl-modal-btn-group">

								<button class="btn btn--e-brand-b-2" type="submit">ĐẶT MUA</button>
