							...
							<div class="col-lg-6 col-md-8 u-s-m-b-30">
								<div class="l-f-o">
									<div class="l-f-o__pad-box">
										...
										<span class="gl-text u-s-m-b-30">Nếu bạn có một tài
										...
										<form:form action="do-login" class="l-f-o__form" method="post"
											...
											<div class="gl-s-api">
												<div class="u-s-m-b-15">
													...
													<button class="gl-s-api__btn gl-s-api__btn--fb"
														type="button">
														<i class="fab fa-facebook-f"></i> <span>Đăng nhập
															bằng Facebook</span>
													</button>
												</div>
												<div class="u-s-m-b-15">
													...
													<button class="gl-s-api__btn gl-s-api__btn--gplus"
														type="button">
														<i class="fab fa-google"></i> <span>Đăng nhập
															bằng Google</span>
													</button>
												</div>
											</div>
											<div class="u-s-m-b-30">
												...
												<label class="gl-label" for="login-email">TÊN ĐĂNG NHẬP *</label>
												<form:input path="userName"
													class="input-text input-text--primary-style" type="text"
													id="login-email" placeholder="Tên đăng nhập" />
												<form:errors style="color:red; font-size: 13px" path="userName" />
											</div>
											<div class="u-s-m-b-30">
												...
												<form:input path="password"
													...
													id="login-password" placeholder="Mật khẩu" />
												<form:errors style="color:red; font-size: 13px" path="password" />
