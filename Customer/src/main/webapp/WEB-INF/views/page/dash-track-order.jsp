...
<title>QuickBuy - Theo Dõi Đơn Hàng</title>
						...
						<div class="breadcrumb">
							<div class="breadcrumb__wrap">
								<ul class="breadcrumb__list">
									...
									<li class="is-marked"><a href="dash-track-order">Tài
											khoản của tôi</a></li>
								</ul>
							</div>
						</div>
									...
									<div
										...
										<div class="dash__pad-1">
											...
											<ul class="dash__f-list">
												...
												<li><a class="dash-active" href="dash-track-order">Theo
														dõi đơn hàng</a></li>
								...
								<div class="col-lg-9 col-md-12">
									<div
										...
										<div class="dash__pad-2">
											<h1 class="dash__h1 u-s-m-b-14">Theo dõi đơn hàng của
												bạn</h1>

											<span class="dash__text u-s-m-b-30">Để theo dõi đơn
												hàng của bạn, vui lòng nhập ID đơn hàng của bạn vào ô bên
												dưới và nhấn nút "Theo dõi". Điều này đã được trao cho bạn
												trên biên nhận của bạn và trong email xác nhận mà lẽ ra bạn
												phải nhận được.</span>
											<form class="dash-track-order">
												<div class="gl-inline">
													<div class="u-s-m-b-30">

														<label class="gl-label" for="order-id">ID đơn đặt hàng *</label>

														<input class="input-text input-text--primary-style"
															type="text" id="order-id"
															placeholder="Tìm thấy trong email xác nhận của bạn">
													</div>
													<div class="u-s-m-b-30">
														...
														<input class="input-text input-text--primary-style"
															type="text" id="track-email"
															placeholder="Email bạn đã sử dụng khi thanh toán">
													</div>
												</div>

												<button class="btn btn--e-brand-b-2" type="submit">THEO DÕI</button>
											</form>
										</div>
									</div>
								</div>
