									...
									<div class="l-f-o__pad-box">
										...
										<form:form action="do-signup" method="post"
											...
											<div class="gl-s-api">
												<div class="u-s-m-b-15">
													...
													<button class="gl-s-api__btn gl-s-api__btn--fb"
														type="button">
														<i class="fab fa-facebook-f"></i> <span>Đăng ký
															bằng Facebook</span>
													</button>
												</div>
												<div class="u-s-m-b-30">
													...
													<button class="gl-s-api__btn gl-s-api__btn--gplus"
														type="button">
														<i class="fab fa-google"></i> <span>Đăng ký bằng
															Google</span>
													</button>
												</div>
											</div>
											...
											<div class="u-s-m-b-30">
												...
												<label class="gl-label" for="reg-lname">HỌ *</label>
												<form:input path="lastName"
													class="input-text input-text--primary-style" type="text"
													id="reg-lname" placeholder="Họ" />
												<form:errors style="color:red; font-size: 13px"
													path="lastName" />
											</div>
											...
											<div class="u-s-m-b-30">
												...
												<form:errors style="color:red; font-size: 13px" path="email" />
											...
											<div class="u-s-m-b-30">
												...
												<form:errors style="color:red; font-size: 13px" path="phone" />
											</div>
											<div class="u-s-m-b-30">
											...
											<div class="u-s-m-b-30">
												...
												<form:input path="password"
													...
													id="reg-password" placeholder="Mật khẩu" />
												<form:errors style="color:red; font-size: 13px"
													path="password" />
											</div>
											<div class="u-s-m-b-30">
												...
												<form:input path="confirmPassword"
													class="input-text input-text--primary-style" type="password"
													id="reg-cpassword" placeholder="Xác nhận mật khẩu" />
