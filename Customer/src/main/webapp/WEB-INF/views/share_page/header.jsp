													...
													<div class="mini-product">
														...
														<div class="mini-product__info-wrapper">
															...
															<span class="mini-product__category"> <a
																href="shop-side-version-2">${cartitem.product.category.categoryName}</a></span> <span
																class="mini-product__name"> <a
																href="product-detail?product-id=${cartitem.product.productID}">Yellow Wireless Headphone</a></span> <span
																class="mini-product__quantity">${cartitem.quantity} x</span> <span
																class="mini-product__price">${cartitem.product.price}00 VNĐ</span>
														</div>
													</div>
										...
										<div class="mini-product-stat">
											<div class="mini-total">
												...
												<span class="subtotal-text">TỔNG TIỀN</span> <span
													class="subtotal-value">${totals} VNĐ</span>
											</div>
